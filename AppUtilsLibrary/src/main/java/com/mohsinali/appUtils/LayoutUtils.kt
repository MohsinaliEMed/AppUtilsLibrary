...
fun requestToSelectImageFromGalllery(activity: Activity) {
   ...
   /* activity.startActivityForResult(Intent.createChooser(intent, "Choose Prescription File"), Constants.REQUEST_CODE_GALLERY)*/
}
...
fun isValidFileSize(realImagePath: String): Boolean {
    ...
    return fileSizeInMB < 10 // MAXIMUM limit of file
}
